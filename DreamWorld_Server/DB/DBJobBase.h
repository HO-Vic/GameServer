...
using TCP_SessionBaseWeakPtr = std::weak_ptr<TCP_SessionBase>;
}  // namespace sh::IO_Engine
...
class UserDBJobBase
 ...
 public:
  ...
  UserDBJobBase(sh::IO_Engine::TCP_SessionBasePtr session)
      : m_session(session) {
  }
 ...
 protected:
  sh::IO_Engine::TCP_SessionBaseWeakPtr m_session;
};

...
void Server::OnLogin(sh::IO_Engine::TCP_SessionBasePtr session, BYTE* message) {
...
void Server::OnMatchReq(sh::IO_Engine::TCP_SessionBasePtr sessionPtr, BYTE* message) {
...
void Server::OnStressDelay(sh::IO_Engine::TCP_SessionBasePtr sessionPtr, BYTE* message) {

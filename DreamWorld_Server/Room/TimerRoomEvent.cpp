...
//#include "../Room/DeprecatedRoom.h"
//
//TIMER::RoomEvent::RoomEvent(const TIMER_EVENT_TYPE& eventId, const std::chrono::milliseconds& afterTime, std::shared_ptr<DeprecatedRoom> roomRef)
//	:EventBase(eventId, afterTime), m_roomWeakRef(roomRef)
//{
//}
//
//TIMER::RoomEvent::RoomEvent(const TIMER_EVENT_TYPE& eventId, const std::chrono::seconds& afterTime, std::shared_ptr<DeprecatedRoom> roomRef)
//	:EventBase(eventId, afterTime), m_roomWeakRef(roomRef)
//{
//}
//

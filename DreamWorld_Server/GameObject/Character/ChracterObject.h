...
class CharacterObject : public LiveObject {
 ...
 private:
  ...
  struct UodateAngle3 {
    ...
    UodateAngle z;
    UodateAngle3()
        : x(UodateAngle()), y(UodateAngle()), z(UodateAngle()) {
    }
 ...
 public:
  ...
  CharacterObject(const float& maxHp, const float& moveSpeed, const float& boundingSize, const float& attackDamage, std::shared_ptr<RoomBase>& roomRef, const ROLE& role);
...
class MeleeCharacterObject : public CharacterObject {
 public:
  MeleeCharacterObject(const float& maxHp, const float& moveSpeed, const float& attackDamage, const float& boundingSize, std::shared_ptr<RoomBase>& roomRef, const ROLE& role);
...
class RangedCharacterObject : public CharacterObject {
 public:
  RangedCharacterObject(const float& maxHp, const float& moveSpeed, const float& boundingSize, const float& attackDamage, std::shared_ptr<RoomBase>& roomRef, const ROLE& role);

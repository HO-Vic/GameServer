...
class ProjectileObject : public MoveObject {
 ...
 public:
  ProjectileObject(const float& moveSpeed, const float& boundingSize, std::shared_ptr<RoomBase>& roomRef, const XMFLOAT3& startPosition, const XMFLOAT3& directionVector, const float& attackDamage, const SEC& lifeTime);
...
class PlayerProjectileObject : public ProjectileObject {
 public:
  PlayerProjectileObject(const float& moveSpeed, std::shared_ptr<RoomBase>& roomRef, const XMFLOAT3& startPosition, const XMFLOAT3& directionVector, const float& attackDamage, const SEC& lifeTime);
...
class MonsterProjectileObject : public ProjectileObject {
 public:
  MonsterProjectileObject(const float& moveSpeed, const float& boundingSize, std::shared_ptr<RoomBase>& roomRef, const XMFLOAT3& startPosition, const XMFLOAT3& directionVector, const float& attackDamage, const SEC& lifeTime);
...
class CommonArrowObject : public PlayerProjectileObject {
 ...
 private:
  ...
  // 생성자에 int power
 public:
  CommonArrowObject(const float& moveSpeed, std::shared_ptr<RoomBase>& roomRef, const XMFLOAT3& startPosition, const XMFLOAT3& directionVector, const float& attackDamage);
};
...
class TripleArrowObject : public PlayerProjectileObject {
 ...
 public:
  TripleArrowObject(std::shared_ptr<RoomBase> roomRef, const XMFLOAT3& startPosition, const XMFLOAT3& directionVector);
};
...
class IceLanceBall : public PlayerProjectileObject {
 ...
 public:
  IceLanceBall(std::shared_ptr<RoomBase>& roomRef, const XMFLOAT3& startPosition, const XMFLOAT3& directionVector);
};
}  // namespace DreamWorld

...
std::optional<std::shared_ptr<Session>> MatchQueue::GetMatchUser() {
  /*
  ...
  */
  ...
  while (true) {
    std::weak_ptr<Session> matchUserWeakPtr;
...
void MatchQueue::InsertMatchUser(std::shared_ptr<Session>& userRef) {
  m_match.push(userRef);
}

void MatchQueue::InsertCancelUser(std::shared_ptr<Session>& userRef) {
  m_cancel.push(userRef);
}

std::optional<std::shared_ptr<Session>> MatchQueue::GetCancelUser() {
  while (true) {
    std::weak_ptr<Session> cancelUserWeakPtr;

...
#define LOGGER sh::UDP_Echo::LogManager::GetInstance()
#define START_LOGGER sh::UDP_Echo::LogManager::GetInstance().StartLogger
#define WRITE_LOG sh::UDP_Echo::LogManager::GetInstance().WriteLog
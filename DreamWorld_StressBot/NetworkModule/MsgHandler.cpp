...
void NetworkModule::OnLoginSuccess(sh::IO_Engine::TCP_SessionBasePtr session, BYTE* packetHeader) {
...
void NetworkModule::OnIntoInGame(sh::IO_Engine::TCP_SessionBasePtr session, BYTE* packetHeader) {
...
void NetworkModule::OnGameState_Stage(sh::IO_Engine::TCP_SessionBasePtr session, BYTE* packetHeader) {
...
void NetworkModule::OnGameState_Boss(sh::IO_Engine::TCP_SessionBasePtr session, BYTE* packetHeader) {
...
void NetworkModule::OnGameEnd(sh::IO_Engine::TCP_SessionBasePtr session, BYTE* packetHeader) {
  auto sessionPtr = std::static_pointer_cast<Session>(session);
  std::weak_ptr<Session> weakSession = std::static_pointer_cast<Session>(session);
  sessionPtr->InsertJob(
      GlobalObjectPool<sh::Utility::Job>::GetInstance().MakeUnique(
...
void NetworkModule::OnStressTestDelay(sh::IO_Engine::TCP_SessionBasePtr session, BYTE* packetHeader) {
  auto sessionPtr = std::static_pointer_cast<Session>(session);
